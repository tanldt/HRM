...
namespace iHRPCore.SIComponent
{
	...
	public class clsSI
	{
		...
		public static DataRow GetDataByID_param_SI(string strParameterID)
		{
			DataRow iRow = clsCommon.GetDataRow("Pr_SpfrmParameter_Minsalary @Activity='GetDataByID',@ParameterID = '" + strParameterID + "'");
			if(iRow !=null)
				return iRow;
			else
				return null;
	...
	public class clsSISocialIns
	{
		public static DataTable GetSIList(string strEmpID, string strEmpName, string strLevel1, string strLevel2, 
			string strLevel3, string strPosition, string strJobCode, string strLocation, string strCompany, 
			string strStatus, string strFromDate, string strToDate, string strStartFromDate, string strStartToDate, 
			string strLastFromDate, string strLastToDate, string strLSContractTypeID)
		{
			...
			try
			{
				...
				for (int i = 0;i< arrTemp.Length;i++)
				{
					...
					if (strExaminingPlace != "")
						cmd.Parameters.Add("@PlaceExaminingCard", SqlDbType.NVarChar,10).Value = strExaminingPlace;
					else
						cmd.Parameters.Add("@PlaceExaminingCard", SqlDbType.NVarChar,10).Value = DBNull.Value;
					if (strNoteHICard != "")
	...
	public class clsSIInsNoticeData
	{
		...
		public static DataTable GetNoticeData(string strEmpID, string strEmpName, string strLevel1, string strLevel2, 
			...
			string strIsNotice, string strIsSupplement, string strStage)
		{
	...
	public class clsSIUpdateConvalescence
	{
		public static DataTable GetAll(string strEmpID, string strEmpName, string strLevel1, string strLevel2, 
			string strLevel3, string strPosition, string strJobCode, string strLocation, string strCompany, string strStatus,
			string strTerm, string strYear, string strMM, string strRegulations, string strToDate, string strSITime, string strType, string strLanguage, string strVFirstName, string strVLastName)
		{
		...
		public static DataTable GetCreate(string strEmpID, string strEmpName, string strLevel1, string strLevel2, 
			...
			string strPlace, string strConcentrate, string strRegulations, string strPer, string strNote, string strLanguage,string strVFirstName, string strVLastName)
		{
			string strSql = "SI_spfrmUpdateConvalescence @Activity = 'Create', @EmpID = N'" + strEmpID + "', @EmpName = N'" + strEmpName
				...
				+ "', @Place = N'" + strPlace + "', @Concentrate = '" + strConcentrate 
			...
			try
			{
				...
				for (int i = 0;i<= dtgList.Items.Count - 1;i++)
				{
					if (((CheckBox)dtgList.Items[i].FindControl("chkSelect")).Checked)
					{
						...
						if(strLeaveDate != "") 
							cmd.Parameters.Add("@LeaveDate",SqlDbType.NVarChar,10).Value = strLeaveDate;
						else
							cmd.Parameters.Add("@LeaveDate",SqlDbType.NVarChar,10).Value = DBNull.Value;
	...
	public class clsUpdateSalarySI
	{
		public static DataTable GetPRData(string strEmpID, string strEmpName, string strLevel1, string strLevel2, 
			string strLevel3, string strPosition, string strJobCode, string strLocation, string strCompany, string strStatus,
			string strFromDate, string strToDate, string strIsTransfer)
		{
			string strSql = "SI_spfrmUpdateSalarySI @Activity = 'GetAll', @EmpID = N'" + strEmpID + "', @EmpName = N'" + strEmpName
				+ "', @LSLevel1ID = N'" + strLevel1 + "', @LSLevel2ID = N'" + strLevel2 + "', @LSLevel3ID = N'" + strLevel3
				+ "', @LSPositionID = N'" + strPosition + "', @LSJobCodeID = N'" + strJobCode 
				+ "', @LSLocationID = N'" + strLocation + "', @LSCompanyID = N'" + strCompany 
				+ "', @FromDate = N'" + strFromDate + "', @ToDate = N'" + strToDate
	...
	public class clsInsNoticeFund
	{
		public static DataRow GetInsNoticeFund(string strSource, string strMonth, string strStage, 
			string strLSCompanyID, string strCompanyType)
		{
			...
			string strSql = "SI_spGetInsNoticeFund @Activity = '" + strSource + "', @Month = '" + strMonth 
				+ "', @Stage = '" + strStage + "', @LSCompanyID = '" + strLSCompanyID 
	...
	public class clsSIBookList
	{
		...
		public static DataTable CreateListByCondition(string strHaveSIBook, string strFromDate, string strToDate,
			...
			string strPosition, string strJobCode, string strLocation, string strCompany, string strStatus)
		{
			DataTable dt = new DataTable();
	...
	public class ClsSi_DataforC47b
	{
		...
		public static DataTable GetDataForC47B(string strChangeType,string strFromMonth,string strToMonth,string strLanguage,string strEmp,string strEmpName,string strLevel1,string strLevel2,string strLevel3,string strCompany,string strStatus,string strKBC,string strActivity )
		{
				DataTable dtb = new DataTable();
				try
				{
					//dtb=clsCommon.GetDataTable("SI_spfrmDataForC47b @ChangeType=N'"+ strChangeType +"',@FromMonth='"+ strFromMonth +"',@ToMonth='"+ strToMonth +"',@Language='"+ strLanguage +"',@strEmpID='"+ strEmp +"',@strEmpName='"+ strEmpName +"',@strLevel1='"+ strLevel1 +"',@strLevel2='"+ strLevel2 +"',@strLevel3='"+ strLevel3  +"',@strCompany='"+strCompany+"',@Status='"+ strStatus +"',@KCB='"+ strKBC +"',@Activity='"+ strActivity +"'");  
					dtb=clsCommon.GetDataTable("SI_spfrmTimeSheetList @ChangeType=N'"+ strChangeType +"',@FromMonth='"+ strFromMonth +"',@ToMonth='"+ strToMonth +"',@Language='"+ strLanguage +"',@strEmpID='"+ strEmp +"',@strEmpName=N'"+ strEmpName +"',@strLevel1='"+ strLevel1 +"',@strLevel2='"+ strLevel2 +"',@strLevel3='"+ strLevel3  +"',@strCompany='"+strCompany+"',@Status='"+ strStatus +"',@KCB='"+ strKBC +"',@Activity='"+ strActivity +"'");  
				}
				catch(Exception ex) 
				{
		...
		public static DataTable GetDataForCombo(string strLanguage,string strActivity)
		{
			...
			try
			{
				...
				dtb=clsCommon.GetDataTable("SI_spfrmTimeSheetList @Language=N'"+ strLanguage +"',@Activity='"+ strActivity +"'");  
			}
			catch(Exception ex) 
			{
		...
		public static void DeleteDataC47b(string strChangeType,string strFromMonth,string strToMonth,string strLanguage,string strEmp,string strActivity)
		{
			...
			try
			{
				...
				dtb=clsCommon.GetDataTable("SI_spfrmTimeSheetList @ChangeType=N'"+ strChangeType +"',@FromMonth='"+ strFromMonth +"',@ToMonth='"+ strToMonth +"',@Language='"+ strLanguage +"',@strEmpID='"+ strEmp +"',@Activity='"+ strActivity +"'");  
			}
			catch(Exception ex) 
			{
	...
	public class ClsSI_GetDataC47bPlace
	{
		...
		public static DataTable GetDataC47bPlace(string strLanguage,string strReportMonth,string strEmpID,string strName,string strLevel1,string strLevel2,string strLevel3,string strCompany,string strStatus,string strActivityKCB,string strIsNotice,string strChangeDataId,string strLShospitalID_OLD,string strLShospitalID_New,string strIsNoticeDate,string strActivity )
		{
			DataTable dtb = new DataTable();
			try
			{
				dtb=clsCommon.GetDataTable("SI_spfrmGetDataC47b_TPlace @Language=N'"+ strLanguage +"',@ReportedMonth='"+ strReportMonth +"',@strEmpID='"+ strEmpID +"',@strEmpName='"+ strName +"',@strLevel1='"+ strLevel1 +"',@strLevel2='"+ strLevel2 +"',@strLevel3='"+ strLevel3 +"',@strCompany='"+ strCompany  +"',@Status='"+ strStatus +"',@ActivityKCB='"+ strActivityKCB  +"',@IsNotice='"+ strIsNotice +"',@ChangDataID='"+ strChangeDataId  +"',@LShospitalID_OLD='"+strLShospitalID_OLD +"',@LShospitalID_New='"+ strLShospitalID_New  +"',@IsNoticeDate='"+ strIsNoticeDate +"',@Activity='" +strActivity+"'");  
			}
			catch(Exception ex) 
			{
...
*/
	...
	public class ClsSI_Report
	{
			...
			string strMonth, System.Web.UI.Page pPage)
		{
			...
			try
			{
				dt = clsCommon.GetDataTable("SI_sprpt02bTBH @Language='" + sLanguage +
					"',@CompanyID=N'" + CompanyID + 
					"',@Level1ID=N'" + Level1ID +
					"',@Level2ID=N'" + Level2ID + 
					"',@Level3ID=N'" + Level3ID + 
