...
//		private bool		m_bShowToolBar		= true;
		...
		/// Constructor
		/// </summary>
		public PageCommon(string transPage)
		{
			TransPage = transPage;

			this.Load += new System.EventHandler(this.UserControlCommon_Load);
			this.Unload += new EventHandler(UserControlCommon_Unload);
			//this.Error += new System.EventHandler(this.UserControlCommon_Error);
			//this.PreRender += new EventHandler(UserControlCommon_PreRender);
		}
