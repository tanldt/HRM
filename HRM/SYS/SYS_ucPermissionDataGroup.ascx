...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SYS_ucPermissionDataGroup.ascx.cs" Inherits="iHRPCore.SYS.SYS_ucPermissionDataGroup" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
		...
		<TD align="center">
			<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
				<TBODY>
					...
					<TR>
						<TD style="WIDTH: 181px"><asp:label id="Label1" CssClass="labelRequire" Runat="server">Date Group</asp:label></TD>
						<TD></TD>
					...
					<TR>
						<TD width="181" style="WIDTH: 181px"><asp:label id="Label2" CssClass="labelRequire" Runat="server">Cus. group</asp:label></TD>
						<TD width="2%"></TD>
						...
						<TD align="right" width="10%" style="DISPLAY: none"><asp:label id="Label3" CssClass="label" Runat="server">Company</asp:label></TD>
						<TD style="DISPLAY: none"></TD>
						<TD width="30%" style="DISPLAY: none"><asp:dropdownlist id="cboLSLevel1ID" runat="server" CssClass="combo" Width="100%" onchange="ChangeLevel1()"></asp:dropdownlist></TD>
					</TR>
					<TR style="DISPLAY: none">
						<TD style="WIDTH: 181px"><asp:label id="Label4" CssClass="label" Runat="server">Department</asp:label></TD>
						<TD></TD>
					...
					<TR style="DISPLAY: none">
						<TD style="WIDTH: 181px"><asp:label id="Label5" CssClass="label" Runat="server">Group</asp:label></TD>
						<TD></TD>
					...
					<TR style="DISPLAY: none">
						<TD style="WIDTH: 181px"><asp:label id="Label6" CssClass="label" Runat="server">Right</asp:label></TD>
						<td>
...
<tr align="center">
	<td>
		<table>
			<TR>
				<TD align="left"><asp:label id="Label7" runat="server" CssClass="labelrequire">Company list</asp:label></TD>
				<TD align="center"></TD>
				<TD align="left"><asp:label id="Label8" runat="server" CssClass="labelrequire">Companys Assigned</asp:label></TD>
			</TR>
			<tr align="center">
