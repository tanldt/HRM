namespace iHRPCore.SYS
{
	...
	/// <summary>
	///		Summary description for SYS_ucUserAccountList.
	/// </summary>
	public class SYS_ucUserAccountList : System.Web.UI.UserControl
	{
		...
		private void BindDataGrid()
		{
			try
			{
				DataTable dtb = clsCommon.GetDataTable("UMS_sptblUserAccount 'GetAllUserAccount',@result='',@UserGroupID=N'" + this.txtUserID.Text.Trim() + "', @LSCompanyID = '"+Mession.GlbCusGroupID+"'");
