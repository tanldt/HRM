...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SYS_ucPermissionDataComp.ascx.cs" Inherits="iHRPCore.SYS.SYS_ucPermissionDataComp" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
		...
		<TD align="center">
			<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
				<TBODY>
					...
					<TR>
						<TD style="WIDTH: 181px"><asp:label id="Label1" CssClass="labelRequire" Runat="server">User</asp:label></TD>
						<TD></TD>
