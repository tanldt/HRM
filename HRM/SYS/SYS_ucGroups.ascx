<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SYS_ucGroups.ascx.cs" Inherits="iHRPCore.SYS.SYS_ucGroups" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
		...
		<td align="center">
			<TABLE width="100%">
					...
					<td align="center">
						<TABLE width="70%">
							<TR>
								...
								<TD><asp:textbox id="txtGroupID" CssClass="input" Runat="server" MaxLength="20" Width="247px"></asp:textbox></TD>
							</TR>
							<TR>
								<TD><asp:label id="lblGroupNameCaption" CssClass="labelRequire" Runat="server">Group Name:</asp:label></TD>
								<TD><asp:textbox id="txtGroupName" CssClass="input" Runat="server" MaxLength="50" Width="247"></asp:textbox></TD>
							</TR>
						</TABLE>
					</td>
				</tr>
				...
				<TR style="DISPLAY: none">
					<TD align="center" colSpan="2"><asp:linkbutton id="btnSearch" accessKey="F" runat="server" CssClass="btnSearch" ToolTip="F">Search</asp:linkbutton></TD>
				</TR>
			</TABLE>
		</td>
	</tr>
		...
		<td style="HEIGHT: 310px" vAlign="top" borderColor="#ffffff" colSpan="3">
			<asp:datagrid id="dgGroups" runat="server" CssClass="grid" Width="100%" AllowPaging="True" AllowSorting="True"
				...
				<Columns>
					...
					<asp:TemplateColumn SortExpression="UserGroupID" HeaderText="Group ID">
					...
					<asp:BoundColumn DataField="UserGroupName" SortExpression="UserGroupName" HeaderText="Group name">
					...
					<asp:TemplateColumn HeaderText="Select">
						...
						<HeaderTemplate>
							<asp:CheckBox id="chkSelectAll" onclick="CheckAll('_ctl0_dgGroups__ctl2_chkSelectAll','_ctl0_dgGroups',3,1,'chkSelect')"
...
<script language="javascript">
	...
	function CheckDelete()
	{
		if (GridCheck('_ctl0_dgGroups', 3, 1, 'chkSelect') == false)
		{
			...
			GetAlertError(iTotal,DSAlert,"ucG0003");
			return false;
		}
