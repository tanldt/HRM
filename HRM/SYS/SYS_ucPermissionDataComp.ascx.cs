namespace iHRPCore.SYS
{
	...
	/// <summary>
	///		Summary description for SYS_ucPermissionDataComp.
	/// </summary>
	public class SYS_ucPermissionDataComp : System.Web.UI.UserControl
	{
		...
		{
			Response.Redirect("Editpage.aspx?ModuleID=SYS&ParentID=157&FunctionID=564&Ascx=SYS/SYS_ucPermissionDataComp.ascx");
			lblErr.Text="";
			AddNew();		
