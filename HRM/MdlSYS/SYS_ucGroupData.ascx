...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SYS_ucGroupData.ascx.cs" Inherits="MdlSYS.SYS_ucGroupData" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<table width="100%">
	<tr>
		<td align="center">
			<TABLE width="100%">
				...
				<tr>
					<td align="center">
						<TABLE width="70%">
							<TR>
								<TD width="30%"><asp:label id="lblGroupIDCaption" CssClass="labelRequire" Runat="server">Group Data ID</asp:label></TD>
								<TD><asp:textbox id="txtGroupID" CssClass="input" Runat="server" MaxLength="10" Width="70%"></asp:textbox></TD>
							</TR>
							<TR>
								<TD><asp:label id="lblGroupNameCaption" CssClass="labelRequire" Runat="server"> Group Data Name</asp:label></TD>
		...
		<td style="HEIGHT: 310px" vAlign="top" borderColor="#ffffff" colSpan="3">
			<asp:datagrid id="dgGroups" runat="server" CssClass="grid" Width="100%" AllowPaging="True" AllowSorting="True"
				...
				<Columns>
					...
					<asp:TemplateColumn SortExpression="UserGroupID" HeaderText="Group Data ID">
					...
					<asp:BoundColumn DataField="UserGroupName" SortExpression="UserGroupName" HeaderText="Group Data Name">
