namespace MdlSYS
{
	...
	/// <summary>
	///		Summary description for SYS_ucAssignGroupToMaster.
	/// </summary>
	public class SYS_ucAssignGroupToMaster : System.Web.UI.UserControl
	{
		...
		{
			clsCommon.LoadDropDownListControl(cboGroupListID,"UMS_sptblUserAccount 'GetAllGroup', @result=''","UserGroupID","UserGroupName",true);
		}
...
//				"',@Status='"+ strStatus +"',@LSEmpTypeID='" + strEmpType + "'");
			}
			else
			{
				dt = clsCommon.GetDataTable("UMS_sptblUserAccount @Activity='GetUserList',@GroupID='" + sGroupID + "'");
