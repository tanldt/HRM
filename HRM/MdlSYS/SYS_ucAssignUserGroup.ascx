...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SYS_ucAssignUserGroup.ascx.cs" Inherits="iHRPCore.SYS_ucAssignUserGroup" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<TABLE id="Table1" cellSpacing="6" cellPadding="0" width="100%" border="0">
	<TR style="display:none">
		<TD class="labelRequire" colSpan="3">
			<uc1:EmpHeaderSearch id="EmpHeaderSearch1" runat="server"></uc1:EmpHeaderSearch></TD>
	</TR>
	<TR>
		<TD class="labelRequire" colSpan="3"><asp:label id="Label1" Width="87px" runat="server" CssClass="labelrequire">Group</asp:label><asp:dropdownlist id="cboGroupListID" Width="250px" runat="server" CssClass="combo"></asp:dropdownlist>&nbsp;
