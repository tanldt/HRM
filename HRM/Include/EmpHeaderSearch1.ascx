...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EmpHeaderSearch1.ascx.cs" Inherits="iHRPCore.Include.EmpHeaderSearch1" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%
	...
	<TR>
		...
		<TD align="center" background="images/table_13.jpg">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="1" width="100%" border="0">
				<TR>
					<TD width="10%"><asp:label id="Label7" CssClass="label" runat="server"> ID</asp:label></TD>
					...
					<TD width="8%"><asp:label id="Label2" CssClass="label" runat="server"> Name</asp:label></TD>
					<TD width="27%"><asp:textbox onkeypress="checkKey('_ctl0_btnSearch')" id="txtEmpName" CssClass="input" runat="server"
							Width="95%"></asp:textbox><%if(Request.Params["EmpID"] == null && Request.Params["EmpName"] == null){%><%}%></TD>
					<TD width="10%"><asp:label id="Label11" CssClass="label" runat="server"> Short Name</asp:label></TD>
					<TD width="33%"><asp:textbox onkeypress="checkKey('_ctl0_btnSearch')" id="txtShortName" CssClass="input" runat="server"
							Width="95%" MaxLength="50"></asp:textbox></TD>
				</TR>
				<TR>
					<TD style="HEIGHT: 17px"><asp:label id="Label3" CssClass="label" runat="server">Department</asp:label></TD>
					<TD style="HEIGHT: 17px"><asp:dropdownlist onkeypress="checkKey('_ctl0_btnSearch')" id="cboLevel1" CssClass="combo" runat="server"
							Width="100%" onchange="ChangeLevel1()"></asp:dropdownlist></TD>
					<TD style="HEIGHT: 17px"><asp:label id="Label4" CssClass="label" runat="server"> Section</asp:label></TD>
					<TD style="HEIGHT: 17px"><asp:dropdownlist onkeypress="checkKey('_ctl0_btnSearch')" id="cboLevel2" CssClass="combo" runat="server"
							Width="95%" onchange="ChangeLevel2()"></asp:dropdownlist></TD>
					<TD style="HEIGHT: 17px"><asp:label id="lblSource" CssClass="label" runat="server">Source</asp:label></TD>
					<TD style="HEIGHT: 17px"><asp:dropdownlist onkeypress="checkKey('_ctl0_btnSearch')" id="cboLSRESourceID" CssClass="combo" runat="server"
							Width="95%"></asp:dropdownlist></TD>
				</TR>
				<TR>
					<TD><asp:label id="Label5" CssClass="label" runat="server">Location</asp:label></TD>
					<TD><asp:dropdownlist onkeypress="checkKey('_ctl0_btnSearch')" id="cboLocation" CssClass="combo" runat="server"
							Width="100%"></asp:dropdownlist></TD>
					<TD>
						<asp:label id="Label12" CssClass="label" runat="server">Local/Expat</asp:label></TD>
					<TD>
						<asp:dropdownlist onkeypress="checkKey('_ctl0_btnSearch')" id="cboLocalExpat" CssClass="combo" runat="server"
							Width="95%">
							<asp:ListItem Value=""></asp:ListItem>
							<asp:ListItem Value="0">Local</asp:ListItem>
							<asp:ListItem Value="1">Expat</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD>
						<asp:label id="Label13" CssClass="label" runat="server">Gender</asp:label></TD>
					<TD>
						<asp:dropdownlist onkeypress="checkKey('_ctl0_btnSearch')" id="cboGender" CssClass="combo" runat="server"
							Width="95%">
				...
				<TR style="DISPLAY: none">
					...
					<TD><asp:dropdownlist onkeypress="checkKey('_ctl0_btnSearch')" id="cboPosition" CssClass="combo" runat="server"
							Width="100%"></asp:dropdownlist></TD>
					...
					<TD><asp:label id="Label9" CssClass="label" runat="server">JobCode</asp:label></TD>
					<TD><asp:dropdownlist onkeypress="checkKey('_ctl0_btnSearch')" id="cboJobcode" CssClass="combo" runat="server"
				...
				<TR style="DISPLAY: none">
					<td align="center" colSpan="6"><INPUT id="txtLevel2ID" style="WIDTH: 9px; HEIGHT: 22px" type="hidden" size="1" name="txtLevel2ID"
							...
							runat="server"><asp:label id="Label1" CssClass="label" runat="server"> Company</asp:label>
