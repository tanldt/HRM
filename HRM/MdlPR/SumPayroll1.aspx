<%@ Page language="c#" Codebehind="SumPayroll1.aspx.cs" AutoEventWireup="false" Inherits="iHRPCore.MdlPR.SumPayroll1" %>
...
//-->
		...
		<form id="Form1" method="post" runat="server">
			...
			if(tblMaster.Rows.Count > 0)
			{
				...
				{
					// Phần Detail
					tblDetail = clsCommon.GetDataTable("LS_spfrmSalaryItem1 @Activity = 'DataPayroll_DetailID',@LanguageID = '" +strLanguage+ "',@LSSalaryItemTypeID = '" + tblMaster.Rows[i]["LSSalaryItemTypeID"].ToString() + "'");
