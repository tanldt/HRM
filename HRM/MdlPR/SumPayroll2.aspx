...
<%@ Page language="c#" Codebehind="SumPayroll2.aspx.cs" AutoEventWireup="false" Inherits="iHRPCore.MdlPR.SumPayroll2" %>
...
//-->
		...
		<form id="Form1" method="post" runat="server">
			...
			if(tblMaster.Rows.Count > 0)
			{
				...
				{
					// Phần Detail
					tblDetail = clsCommon.GetDataTable("LS_spfrmSalaryItem2 @Activity = 'DataPayroll_DetailID',@LanguageID = '" +strLanguage+ "',@LSSalaryItemTypeID = '" + tblMaster.Rows[i]["LSSalaryItemTypeID"].ToString() + "'");
