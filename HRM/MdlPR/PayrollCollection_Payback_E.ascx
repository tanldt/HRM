...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PayrollCollection_Payback_E.ascx.cs" Inherits="iHRPCore.MdlPR.PayrollCollection_Payback_E" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<%
...
<TABLE id="Table1" style="WIDTH: 100%" cellSpacing="2" cellPadding="2" width="300" border="0">
	<TR>
		<TD align="left"><asp:label Visible="False" id="lblErr" runat="server" CssClass="label"></asp:label></TD>
	</TR>
	<TR>
		<TD align="center">
			<TABLE id="Table2" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" border="0">
				<TR>
					...
					<TD width="30%"><asp:textbox id="txtMonth" onblur="javascript:CheckMonthYear(this)" runat="server" CssClass="input"
							MaxLength="7" Width="70%"></asp:textbox></TD>
					<TD width="15%">&nbsp;<asp:label id="Label1" runat="server" CssClass="label" Visible="False"> Salary Period</asp:label></TD>
					<TD width="50%"><asp:textbox id="txtSalPeriod" runat="server" CssClass="input" MaxLength="12" Width="70%" Visible="False"
							ReadOnly="True"></asp:textbox></TD>
				</TR>
				<TR>
					<TD width="15%">
						<asp:label id="Label2" CssClass="label" runat="server">Emp ID</asp:label></TD>
					<TD width="30%">
						<asp:textbox id="txtEmpID" onblur="javascript:CheckMonthYear(this)" CssClass="input" runat="server"
							ReadOnly="True" Width="70%" MaxLength="7"></asp:textbox></TD>
					<TD width="15%">
						<asp:label id="Label8" CssClass="label" runat="server">Full Name</asp:label></TD>
					<TD width="50%">
						<asp:textbox id="txtEmpName" onblur="javascript:CheckMonthYear(this)" CssClass="input" runat="server"
							ReadOnly="True" Width="70%" MaxLength="7"></asp:textbox></TD>
				</TR>
				<TR>
					<TD align="left" width="15%" style="HEIGHT: 14px"><asp:label id="Label3" runat="server" CssClass="labelRequire">Corporation</asp:label></TD>
					<TD style="HEIGHT: 14px"><asp:dropdownlist id="cboCompanyID" runat="server" CssClass="select" Width="100%" onchange="ChangeCompany()"></asp:dropdownlist></TD>
					<TD style="HEIGHT: 14px">&nbsp;<asp:label id="Label4" runat="server" CssClass="label">Company</asp:label></TD>
					<TD style="HEIGHT: 14px"><asp:dropdownlist id="cboLevel1ID" runat="server" CssClass="select" Width="100%" onchange="ChangeLevel1()"></asp:dropdownlist></TD>
				</TR>
				<TR>
	...
	<TR>
		<TD align="center"><asp:linkbutton id="btnNewPayroll" accessKey="S" runat="server" CssClass="btnSave" ToolTip="ALT+S">Create</asp:linkbutton>&nbsp;
			<asp:linkbutton id="btnCalulate" accessKey="E" runat="server" CssClass="btnExport" ToolTip="Alt + T"> Calculate</asp:linkbutton>&nbsp;
			...
			<asp:linkbutton id="btnLock" accessKey="E" runat="server" CssClass="btnExport">Lock Salary</asp:linkbutton>&nbsp;
			<asp:linkbutton id="btnPrint" accessKey="E" runat="server" CssClass="btnExport">Print</asp:linkbutton></TD>
	</TR>
	...
	<TR>
		<TD align="center"><asp:datagrid id="grdPayRoll" runat="server" CssClass="grid" Width="100%" BorderColor="#3366CC"
				...
				<Columns>
					...
					<asp:BoundColumn DataField="Total" SortExpression="Total" HeaderText="Monthly Salary & Allowances">
						<HeaderStyle Width="7%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundColumn>
					<asp:BoundColumn DataField="NetSalaryUSD" SortExpression="NetSalaryUSD" HeaderText="Net Salary/Allow.">
						<HeaderStyle Width="7%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundColumn>
					<asp:BoundColumn DataField="GrossUpUSD" SortExpression="GrossUpUSD" HeaderText="Net Income Grossed-up">
						<HeaderStyle Width="7%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundColumn>
					<asp:BoundColumn DataField="HousingPIT" SortExpression="HousingPIT" HeaderText="Housing">
						<HeaderStyle Width="10%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundColumn>
					<asp:BoundColumn DataField="TaxableIncomeUSD" SortExpression="TaxableIncomeUSD" HeaderText="Taxable Income">
						<HeaderStyle Width="10%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundColumn>
					<asp:BoundColumn DataField="PayableTaxAmount" SortExpression="PayableTaxAmount" HeaderText="Payable Tax Amount">
						<HeaderStyle Width="10%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundColumn>
	...
	<TR style="DISPLAY: none">
		<TD align="center"><INPUT id="txtLevel1ID" type="hidden" runat="server" NAME="txtLevel1ID"><INPUT id="txtLevel2ID" type="hidden" runat="server" NAME="txtLevel2ID"><INPUT id="txtLevel3ID" type="hidden" runat="server" NAME="txtLevel3ID">
...
function Lock()
{
	if(confirm(GetAlertText(iTotal,DSAlert,"PC_0002_P"))==false){
		return false;
	}
}
...
function ShowPage()
{
	...
	window.open('MdlPR/SumPayroll2.aspx?MMYYYY='+Month+'&SalPeriod=' +SalPeriod + '&Comp=' + CompanyID + '&L1=' +Level1ID+ '&L2=' +Level2ID+ '&L3=' +Level3ID+ '','SelectFile','status=1,toolbar=1,scrollbars=1,resizable=1,alwaysRaised=Yes, top=20, left=30, width=800, height=600,1 ,align=center');
	return false;
}
</script>
