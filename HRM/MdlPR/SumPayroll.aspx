<%@ Page language="c#" Codebehind="SumPayroll.aspx.cs" AutoEventWireup="false" Inherits="iHRPCore.MdlPR.SumPayroll" %>
...
classid=clsid:1663ed61-23eb-11d2-b92f-008048fdd814 viewastext>
		...
		<form id="Form1" method="post" runat="server">
			...
			if(tblMaster.Rows.Count > 0)
			{
				...
				{
					// Phần Detail
					tblDetail = clsCommon.GetDataTable("LS_spfrmSalaryItem @Activity = 'DataPayroll_DetailID',@LanguageID = '" +strLanguage+ "',@LSSalaryItemTypeID = '" + tblMaster.Rows[i]["LSSalaryItemTypeID"].ToString() + "'");
