...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PayrollCollection_Payback_S.ascx.cs" Inherits="iHRPCore.MdlPR.PayrollCollection_Payback_S" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<%
	...
	<TR>
		<TD align="center">
			<TABLE id="Table2" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" border="0">
				...
				<TR>
					<TD align="left" width="15%"><asp:label id="Label3" runat="server" CssClass="labelRequire">Corporation</asp:label></TD>
...
function ShowPage()
{
	...
	window.open('MdlPR/SumPayroll3.aspx?MMYYYY='+Month+'&SalPeriod=' +SalPeriod + '&Comp=' + CompanyID + '&L1=' +Level1ID+ '&L2=' +Level2ID+ '&L3=' +Level3ID+ '','SelectFile','status=1,toolbar=1,scrollbars=1,resizable=1,alwaysRaised=Yes, top=20, left=30, width=800, height=600,1 ,align=center');
	return false;
}
</script>
