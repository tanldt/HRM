...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PayrollCollection_Expat.ascx.cs" Inherits="iHRPCore.MdlPR.PayrollCollection_Expat" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<%
	...
	<TR>
		<TD align="center">
			<TABLE id="Table2" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" border="0">
				...
				<TR>
					<TD align="left" width="15%" style="HEIGHT: 14px"><asp:label id="Label3" runat="server" CssClass="labelRequire">Customer group</asp:label></TD>
