<%@ Control Language="c#" AutoEventWireup="false" Codebehind="OnlineAprovedPayroll.ascx.cs" Inherits="MdlPR.LockPayroll1" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
