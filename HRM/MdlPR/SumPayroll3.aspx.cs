...
{
	/// <summary>
	/// Summary description for SumPayroll3.
	/// </summary>
	public class SumPayroll3 : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!Page.IsPostBack)
			{
				tblMaster = clsCommon.GetDataTable("LS_spfrmSalaryItem3  @Activity = 'AllDataPayroll_Master',@LanguageID = '" +strLanguage+ "'");
				BindData();
				
				dtList = clsPRCollection.GetDataSalaryAll3(strComp,strL1,strL2,strL3,strEmpCode);
			}
		}
		...
		private void BindData()
		{
			...
			try
			{				
				dtList = clsCommon.GetDataTable("LS_spfrmSalaryItem3  @Activity = 'All_note',@LanguageID = '" +strLanguage+ "'");
