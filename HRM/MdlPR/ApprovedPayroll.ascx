<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ApprovedPayroll.ascx.cs" Inherits="MdlPR.ApprovedPayroll" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
