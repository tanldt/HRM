<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PayrollCollection_Payback_DH.ascx.cs" Inherits="iHRPCore.MdlPR.PayrollCollection_Payback_DH" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
