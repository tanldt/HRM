...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AttendanceIncome.ascx.cs" Inherits="iHRPCore.MdlPR.AttendanceIncome" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%
...
<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="97%" border="0">
			...
			<TABLE cellSpacing="0" cellPadding="1" width="90%" border="0">
				...
				<TR>
					<TD align="left" width="15%" height="24">
						<asp:label id="lblPeriod" CssClass="labelrequire" runat="server">Salary Period</asp:label></TD>
					<TD width="30%">
					...
					<TD align="left" width="12%" height="24">&nbsp;</TD>
	...
	<TR>
		<TD style="HEIGHT: 19px" noWrap align="center" height="19">
			<asp:linkbutton id="btnPrint" accessKey="S" runat="server" CssClass="btnPrint" ToolTip="ALT+P">Preview</asp:linkbutton></TD>
	</TR>
	<TR>
		<TD noWrap align="center" height="10"></TD>
