...
{
	/// <summary>
	/// Summary description for SumPayroll1.
	/// </summary>
	public class SumPayroll1 : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!Page.IsPostBack)
			{
				tblMaster = clsCommon.GetDataTable("LS_spfrmSalaryItem1  @Activity = 'AllDataPayroll_Master',@LanguageID = '" +strLanguage+ "'");
				BindData();
				
				dtList = clsPRCollection.GetDataSalaryAll1(strComp,strL1,strL2,strL3,strEmpCode);
			}
		}
		...
		private void BindData()
		{
			...
			try
			{				
				dtList = clsCommon.GetDataTable("LS_spfrmSalaryItem1  @Activity = 'All_note',@LanguageID = '" +strLanguage+ "'");
