namespace MdlPR
{
	...
	/// <summary>
	///		Summary description for PITIncomeTax.
	/// </summary>
	public class PITIncomeTax : System.Web.UI.UserControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!Page.IsPostBack)
			{
				DataRow iRow =  clsCommon.GetDataRow("PR_spfrmIncomeTax @Activity='TopData'");
				if(iRow != null)
				{
...
//			myExcelXport = null;
		...
		private DataTable ViewData()
		{
			try
			{
				DataTable dtData = clsCommon.GetDataTableHasID("PR_spfrmIncomeTax @Activity='LoadData',@YYYY='" + txtYear.Text + "'");
				return dtData;
			}
			catch (Exception ex)
			{
		...
		private void btnCalculate_Click(object sender, System.EventArgs e)
		{
			...
			if (lblErr.Text == "")
			{
				string sErr= clsCommon.sExecuteCommandTextTrans("PR_spfrmIncomeTax @Activity='Calculate',@YYYY='" + txtYear.Text + "',@MMYYYY='" + txtMMYYYY.Text + "'");
				if (sErr=="")
