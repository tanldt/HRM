namespace iHRPCore.Reports
{
	...
	/// </summary>
	public class Reports2 : System.Web.UI.UserControl
	{
			...
			try
			{
				...
				{					
					...
					if(dv.Count > 1)
						// End
					{
						str_Script = clsCatalog2.CreateControlsReport(strTableName,Table2, Server.MapPath(".") +  ConfigurationSettings.AppSettings["pstrPathReportsXML"],new DataGrid(),null,null,null,new Label(),null,this);
		...
		{	
			...
			else if (strFileName.IndexOf(".rpt") != -1)
			{
				...
				strParams = "@Language;@EmpID;@EmpName;@CompanyID;@Level1ID;@Level2ID;@Level3ID;@PositionID;@JobCodeID;@LocationID;@Status";
