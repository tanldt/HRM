namespace Reports.PR
{
	...
	/// </summary>
	public class PR_rptSalarySecond : System.Web.UI.UserControl
	{
		...
		private void btnView_Click(object sender, System.EventArgs e)
		{
			...
			DataTable	dt = clsCommon.GetDataTable("PR_SalarySecond @Language='" + sLanguage +
				"',@CompanyID=N'" + Company + 
				"',@Level1ID=N'" + Level1 +
				"',@Level2ID=N'" + Level2 + 
				"',@Level3ID=N'" + Level3 + 
			...
			try
			{
				...
				DataTable	dtSI_ComInfo = clsCommon.GetDataTable("PR_SalarySecond @Language='" + sLanguage +
					"',@CompanyID=N'" + Company + 
					"',@Level1ID=N'" + Level1 +
					"',@Level2ID=N'" + Level2 + 
					"',@Level3ID=N'" + Level3 + 
				...
				bc.sfileTemplate = "PR_SalarySecond.htm";
		...
		{
			DataRow dr = clsCommon.GetDataRow("PR_SalarySecond @MMYYYY = '" + strMonth + "'");
			if (dr == null)
			{
