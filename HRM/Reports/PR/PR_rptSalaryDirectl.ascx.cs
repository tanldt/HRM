namespace Reports.PR
{
	...
	/// </summary>
	public class PR_rptSalaryDirect : System.Web.UI.UserControl
	{
		...
		private void btnView_Click(object sender, System.EventArgs e)
		{
			...
			DataTable	dt = clsCommon.GetDataTable("PR_SalaryDirect @Language='" + sLanguage +
				"',@CompanyID=N'" + Company + 
				"',@Level1ID=N'" + Level1 +
				"',@Level2ID=N'" + Level2 + 
				"',@Level3ID=N'" + Level3 + 
			...
			try
			{
				...
				DataTable	dtSI_ComInfo = clsCommon.GetDataTable("PR_SalaryDirect @Language='" + sLanguage +
					"',@CompanyID=N'" + Company + 
					"',@Level1ID=N'" + Level1 +
					"',@Level2ID=N'" + Level2 + 
					"',@Level3ID=N'" + Level3 + 
				...
				bc.sfileTemplate = "PR_SalaryDirect.htm";
		...
		{
			DataRow dr = clsCommon.GetDataRow("PR_SalaryDirect @MMYYYY = '" + strMonth + "'");
			if (dr == null)
			{
