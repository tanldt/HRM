<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PR_rptSalarySecond.ascx.cs" Inherits="Reports.PR.PR_rptSalarySecond" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
