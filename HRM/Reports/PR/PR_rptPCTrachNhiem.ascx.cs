namespace Reports.PR
{
	...
	/// <summary>
	///		Summary description for PR_rptPCTrachNhiem.
	/// </summary>
	public class PR_rptPCTrachNhiem : System.Web.UI.UserControl
	{
		...
		private void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				dt= ClsPR_Report.GetData_PR_rptPCTrachNhiem(strCompany,strLevel1,strLevel2,strLevel3,
				...
				bc.sfileTemplate = "PR_rptPCTrachNhiem.htm";
