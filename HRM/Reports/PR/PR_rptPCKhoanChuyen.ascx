<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PR_rptPCKhoanChuyen.ascx.cs" Inherits="Reports.TMS.PR_rptPCKhoanChuyen" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
