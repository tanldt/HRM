...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Reports.ascx.cs" Inherits="iHRPCore.Reports.Reports" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<TABLE id="tblMain" cellSpacing="0" cellPadding="0" width="97%" border="0">
	...
	<TR>
		...
		<uc1:empheadersearch id="EmpHeaderSearch1" runat="server">
		</uc1:empheadersearch>
	...
	<TR vAlign="top">
		<TD vAlign="top" align="center">
			<!--<HR width="95%">-->
			<asp:linkbutton id="btnPreview" CssClass="Button" runat="server">View</asp:linkbutton><INPUT id="_ctl0_btnSearch" type="button" value="Button" style="DISPLAY: none">
		</TD>
	</TR>
</TABLE>
