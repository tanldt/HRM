<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rptC67a_EN.ascx.cs" Inherits="Reports.HR.SI_rptC67a_EN" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table width="100%">
	...
	<TR style="DISPLAY:none">
		...
		<TD colspan="4"><asp:textbox id="txtTitle" runat="server" CssClass="input" Width="80%">C 67a </asp:textbox></TD>
	<TR>
		<TD width="15%">
	...
	<TR>
		<TD width="15%"><asp:label id="Label3" CssClass="labelRequire" runat="server">Stage</asp:label></TD>
		<TD width="20%"><asp:textbox id="txtStage" onblur="checkStage(this)" CssClass="input" runat="server" Width="80px"
