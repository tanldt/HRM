<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rpt02aTBH_EN.ascx.cs" Inherits="Reports.HR.SI_rpt02aTBH_EN" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
