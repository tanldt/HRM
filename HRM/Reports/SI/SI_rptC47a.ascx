<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rptC47a.ascx.cs" Inherits="Reports.HR.SI_rptC47a" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
