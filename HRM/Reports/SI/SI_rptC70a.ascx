...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rptC70a.ascx.cs" Inherits="Reports.HR.SI_rptC70a" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table width="100%">
	<TR>
