<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rptC68a.ascx.cs" Inherits="Reports.HR.SI_rptC68a" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table width="100%">
	...
	<TR style="DISPLAY:none">
		...
		<TD colspan="4"><asp:textbox id="txtTitle" runat="server" CssClass="input" Width="80%">C 68a </asp:textbox></TD>
	<TR>
		<TD width="15%">
