namespace Reports.HR
{
	...
	/// <summary>
	///		Summary description for SI_rptC67a.
	/// </summary>
	public class SI_rptC67a_EN : System.Web.UI.UserControl
	{
		...
		private void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				dt= ClsSI_Report.GetData_C67a(strCompany,strLevel1,strLevel2,strLevel3,
					strEmpID,strEmpName,strStatus,strLocation,strPosition,strJobcode,strMonth,this.Page);

				#region Header Company Info
				DataTable dtSI_ComInfo= ClsSI_Report.GetData_ComInfo(strLevel1,strMonth,txtStage.Text.ToString(),this.Page);
				...
				bc.sfileTemplate = "SI_rptC67a_EN.htm";
