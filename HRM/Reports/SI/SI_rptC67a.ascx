<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rptC67a.ascx.cs" Inherits="Reports.HR.SI_rptC67a" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
