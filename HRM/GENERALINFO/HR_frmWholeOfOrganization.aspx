<%@ Page language="c#" Codebehind="HR_frmWholeOfOrganization.aspx.cs" AutoEventWireup="false" Inherits="HRWebServiceC.UserServices.GeneralInfo.HR_frmWholeOfOrganization" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>HR_frmWholeOfOrganization</title>
			...
			<TABLE align="center" id="Table1" style="Z-INDEX: 102; LEFT: 8pt; WIDTH: 400px; POSITION: absolute; TOP: 8pt; HEIGHT: 27px"
				...
				<TR>
					<TD align="center" bgColor="#ffffff"><asp:label id="lblTitle" runat="server" Font-Bold="True" ForeColor="Gray" Font-Size="12&#13;&#10;&#9;&#9;&#9;&#9;&#9;"
							Font-Names="Arial" Height="34px">SƠ ĐỒ TỔ CHỨC</asp:label></TD>
				</TR>
				<TR>
