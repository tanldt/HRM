      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top">
            ...
            <img src="{$img-directory}{@img}"/></a><a class="folder"><xsl:value-of select="@title"/></a>
            <div>
  ...
  <xsl:template match="leaf">
	<table border="0" cellspacing="0" cellpadding="0">
        <tr>
         <td width="40"></td>
         <td valign="top">
         <img src="{$img-directory}{@img}"/> <a class="folder" href="@@@/Editpage.aspx?ModuleID=HR@@ParentID=8@@FunctionID=19@@Ascx=MdlHR/Personal.ascx@@EmpID={@ID}">
