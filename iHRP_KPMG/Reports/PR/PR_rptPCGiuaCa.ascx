...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PR_rptPCGiuaCa.ascx.cs" Inherits="Reports.PR.PR_rptPCGiuaCa" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table width="100%">
	<TR>
