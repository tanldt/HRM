...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PR_rptDetailIncome.ascx.cs" Inherits="Reports.PR.PR_rptDetailIncome" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table width="100%">
	<TR>
