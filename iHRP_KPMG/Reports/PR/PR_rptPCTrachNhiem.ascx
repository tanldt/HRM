<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PR_rptPCTrachNhiem.ascx.cs" Inherits="Reports.PR.PR_rptPCTrachNhiem" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
