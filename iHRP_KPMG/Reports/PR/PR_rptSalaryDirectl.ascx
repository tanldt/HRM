<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PR_rptSalaryDirectl.ascx.cs" Inherits="Reports.PR.PR_rptSalaryDirect" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
