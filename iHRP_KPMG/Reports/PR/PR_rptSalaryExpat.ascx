<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PR_rptSalaryExpat.ascx.cs" Inherits="Reports.PR.PR_rptSalaryExpat" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<table width="100%">
	...
	<TR style="DISPLAY: none">
		<TD width="15%">
			<P align="left"><asp:label id="Label1" runat="server" CssClass="label" Visible="False"> Tiêu đề</asp:label></P>
		</TD>
		<TD colSpan="4"><asp:textbox id="txtTitle" runat="server" CssClass="input" Width="80%" Visible="False">TS_rpt001</asp:textbox></TD>
	<TR>
		<TD width="15%">
			<P align="left"><asp:label id="Label5" runat="server" CssClass="labelRequire">Month</asp:label></P>
		</TD>
		<TD width="20%"><asp:textbox id="txtMMYYYY" onblur="CheckMonthYear(this)" runat="server" CssClass="input" Width="80px"
				MaxLength="7"></asp:textbox></TD>
		<TD width="15%"><asp:radiobuttonlist id="optLanguage" runat="server" Width="204px" RepeatDirection="Horizontal" Visible="False">
...
<!--	
	function checkvalidSearch()
	{
		...
		if (document.getElementById('_ctl0_EmpHeaderSearch1_cboLSEmpTypeID').value == "")
		{
			GetAlertError(iTotal,DSAlert,"0003");
			document.getElementById('_ctl0_EmpHeaderSearch1_cboLSEmpTypeID').focus();
			return false;
		}					
