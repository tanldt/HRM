...
namespace iHRPCore.Reports.WF {
    ...
    public class Report_Moto : ReportClass {
    ...
    public class CachedReport_Moto : Component, ICachedReport {
        
        public CachedReport_Moto() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Report_Moto rpt = new Report_Moto();
            rpt.Site = this.Site;
            return rpt;
        }
