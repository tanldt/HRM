...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="TNCN_Quy.ascx.cs" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" Inherits="Reports.PIT.TNCN_Quy" %>
	...
	<tr>
		<td>
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="99%" border="0">
				...
				<tr>
					<TD><asp:label id="Label4" CssClass="labelrequire" runat="server" Width="100%">Quarter </asp:label></TD>
					<td><asp:dropdownlist id="cboQuarter" CssClass="combo" runat="server" Width="100%">
							<asp:ListItem Value="" Selected="True"></asp:ListItem>
					...
					<td></td>
					<TD><asp:label id="Label5" CssClass="labelrequire" runat="server" Width="100%">Year </asp:label></TD>
					<TD>
...
function validform(){	
	...
	if(checkisnull('cboQuarter')==false)  return false;
	return true;
}
