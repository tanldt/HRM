namespace Reports.HR
{
	...
	/// </summary>
	public class SI_rpt02SBH : System.Web.UI.UserControl
	{
		...
		private void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string MMYYYY=txtDate.Text;
				string Year=MMYYYY.Substring(3,4).Trim();
				int Month=Convert.ToInt32(MMYYYY.Substring(0,2).Trim());
				string Quarter="";
...
//				
//				if (MMYYYY != "" )
//					if (Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("1") || Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("2") || Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("3") )		 
//						strTitle = "QUÝ I " + " - " + Year;
//					else
//						if (Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("4") || Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("5") || Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("6")) 		 
//							strTitle = "QUÝ II " + " - " + Year;
//						else if (Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("7") || Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("8") || Convert.ToInt32(MMYYYY.Substring(0,2)).Equals("9")) 		 
//							strTitle = "QUÝ III " + " - " + Year;	
//						else 
//							strTitle = "QUÝ IV " + " - " + Year;
				...
				dt= ClsSI_Report.GetData_02SBH(Year,Quarter,MMYYYY,strCompany);

				#region Header Company Info
				DataTable dtSI_ComInfo= ClsSI_Report.GetData_ComInfo(strCompany,strMonth,Convert.ToInt32(strStage),this.Page);
				...
				strHeaderValues += ";" + strStage;
				strHeaderParams += ";Title";
				strHeaderValues += ";" + strTitle;
				...
				bc.sfileTemplate = "SI_rpt02SBH.htm";
