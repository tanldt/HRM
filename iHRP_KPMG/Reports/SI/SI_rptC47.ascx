...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rptC47.ascx.cs" Inherits="Reports.HR.SI_rptC47" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table width="100%">
	<TR>
	...
	<TR style="DISPLAY:none">
		...
		<TD colspan="4"><asp:textbox id="txtTitle" runat="server" CssClass="input" Width="80%">SI_rptC47 </asp:textbox></TD>
	<TR>
		<TD width="15%">
	...
	<TR>
		...
		<TD width="20%">
			<asp:textbox id="txtStage" onblur="checkStage(this)" CssClass="input" runat="server" Width="80px"
