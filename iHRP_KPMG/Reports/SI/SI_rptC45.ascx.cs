namespace Reports.HR
{
	...
	/// </summary>
	public class SI_rptC45 : System.Web.UI.UserControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				//BindDataGrid();
				this.txtYear.Text=System.DateTime.Now.ToString("yyyy");
				this.txtDate.Text="30/11/" + System.DateTime.Now.ToString("yyyy");
		...
		private void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string strEmpID = clsCommon.SafeDataString(EmpHeaderSearchReport1.txtEmpID.Text.Trim().Replace("'",""));
				string strEmpName = clsCommon.SafeDataString(EmpHeaderSearchReport1.txtEmpName.Text.Trim().Replace("'",""));
				...
				int strYear=Convert.ToInt32(txtYear.Text);

				dt= ClsSI_Report.GetData_C45(strCompany,strLevel1,strLevel2,strLevel3,
					strEmpID,strEmpName,strStatus,strLocation,strPosition,strJobcode,strMonth,this.Page);

				#region Header Company Info
				DataTable dtSI_ComInfo= ClsSI_Report.GetData_ComInfo(strCompany,strYear,this.Page);
				...
				bc.sfileTemplate = "SI_rptC45.htm";
