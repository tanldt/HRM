namespace Reports.HR
{
	...
	/// </summary>
	public class SI_rpt02a_TBH_EN : System.Web.UI.UserControl
	{
		...
		private void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				dt= ClsSI_Report.GetData_02a_TBH(strCompany,strLevel1,strLevel2,strLevel3,
				...
				DataTable dtSI_Info= ClsSI_Report.GetData_InfoFooter03TBH(strCompany,strMonth,this.Page,strStage);
				...
				bc.sfileTemplate = "SI_rpt02aTBH_New_EN.htm";
