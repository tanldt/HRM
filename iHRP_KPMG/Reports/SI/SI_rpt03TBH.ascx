...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rpt03TBH.ascx.cs" Inherits="Reports.HR.SI_rpt03TBH" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table width="100%">
	<TR>
