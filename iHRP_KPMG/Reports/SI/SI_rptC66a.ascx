<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SI_rptC66a.ascx.cs" Inherits="Reports.HR.SI_rptC66a" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
