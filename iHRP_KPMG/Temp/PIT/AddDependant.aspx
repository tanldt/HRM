<%@ Page language="c#" Codebehind="AddDependant.aspx.cs" AutoEventWireup="false" Inherits="Temp.PIT.Dependant" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		...
		Màn hình thêm bớt người phụ thuộc của thành viên trong nhóm
			<table width="100%">
				<tr>
					<td colspan="2">
						<TABLE id="tblInfo" cellSpacing="0" cellPadding="1" width="98%" border="0">
							...
							<TR id="trReduction" runat="server">
