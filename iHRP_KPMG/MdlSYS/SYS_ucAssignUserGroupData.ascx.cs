namespace iHRPCore
{
	...
	/// <summary>
	///		Summary description for SYS_ucAssignUserGroupData.
	/// </summary>
	public class SYS_ucAssignUserGroupData : System.Web.UI.UserControl
	{
		...
		{
			clsCommon.LoadDropDownListControl(cboGroupListID,"UMS_sptblUserAccount 'GetAllGroupData'","UserGroupID","UserGroupName",true);
		}
		...
		private void BindUserList(string sGroupID, int iEmpSearch)
		{
			...
			if(iEmpSearch==1 )
			{
				...
				dt = clsCommon.GetDataTable("UMS_sptblUserAccount @Activity='GetUserListData',@GroupID='" + sGroupID + 
			...
			{
				dt = clsCommon.GetDataTable("UMS_sptblUserAccount @Activity='GetUserListData',@GroupID='" + sGroupID + "',@LSCompanyID= '"+Mession.GlbCusGroupID+"'");
			}
		...
		private void BindUserGroup(string sGroupID, int iEmpSearch)
		{
			...
			if(iEmpSearch==1 )
			{
			 ...
			 dt = clsCommon.GetDataTable("UMS_sptblUserAccount @Activity='GetUserGroupData',@GroupID='" + sGroupID + 
				"',@EmpID='" + strEmpID + "',@EmpName=N'" + strEmpName + "',@LSCompanyID='" +strCompany+ "',@LSLevel1ID='" + strLevel1 + 
				"', @LSLevel2ID='" + strLevel2 + "',@LSLevel3ID='" + strLevel3 +
				"',@Status='"+ strStatus +"',@LSEmpTypeID='" + strEmpType + "',@UserGroupID = '"+Mession.GlbUser+"'");
			}
			...
			{
				dt = clsCommon.GetDataTable("UMS_sptblUserAccount @Activity='GetUserGroupData',@GroupID='" + sGroupID + "',@LSCompanyID= '"+Mession.GlbCusGroupID+"'");
			}
		...
		private void btnSave_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				*/
				cmd.CommandText = "UMS_sptblUserAccount";
				cmd.Parameters.Clear();
				cmd.Parameters.Add("@Activity", SqlDbType.NVarChar, 50).Value = "SaveUserPerFollowGroupData";			
				cmd.Parameters.Add("@GroupID", SqlDbType.NVarChar, 20).Value=cboGroupListID.SelectedValue;
