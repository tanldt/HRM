namespace iHRPCore.SYS
{
	...
	/// <summary>
	///		Summary description for SYS_ucPermissionDataGroup.
	/// </summary>
	public class SYS_ucPermissionDataGroup : System.Web.UI.UserControl
	{
		...
		{			
			...
			try
			{
				...
				cmd.CommandText = "SYS_spfrmPermissionComp";
				...
				for(int i=0;i<sList.Length;i++)
				{
					...
					cmd.Parameters.Add("@UserGroupID", SqlDbType.VarChar, 12).Value=txtUserGroupID.Text.Trim(); 
					cmd.Parameters.Add("@LSLevel1ID", SqlDbType.VarChar, 12).Value=sList[i].ToString();
					cmd.ExecuteNonQuery();
				}
		...
		private void cmdGetUserAccount_Click(object sender, System.EventArgs e)
		{
			...
			clsCommon.OpenNewWindow(this.Page,"Formpage.aspx?Ascx=SYS/SYS_ucUserAccountListGroupData.ascx","");
		}

		private void btnAddNew_Click(object sender, System.EventArgs e)
		{
			Response.Redirect("Editpage.aspx?ModuleID=SYS&ParentID=157&FunctionID=564&Ascx=SYS/SYS_ucPermissionDataGroup.ascx");
			lblErr.Text="";
			AddNew();		
		...
		{
			string strSQL = "SYS_spfrmPermissionComp @Activity='GetCompanyIDNP'";
			...
			clsCommon.LoadListBoxControl(lstListComp,dt,"ID","Level1Name",false);					
		}
		private void BindUserGroup()
		{
			string strSQL = "SYS_spfrmPermissionComp @Activity='GetCompanyIDP'";
			strSQL +=",@UserGroupID ='"+txtUserGroupID.Text+"', @LSCompanyID = '"+cboLSCompanyID.SelectedValue +"'";
