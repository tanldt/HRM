<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SYS_ucUserAccountListGroupData.ascx.cs" Inherits="iHRPCore.SYS.SYS_ucUserAccountListGroupData" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<table width="100%">
	<TR>
	...
	<tr bgColor="#cccc99" style="display:none">
		<td style="HEIGHT: 5px" bgColor="#ffffff" align="center">
			<asp:label id="Label2" runat="server" Font-Names="Arial" Width="81" Font-Size="8pt" Height="18px"> Group</asp:label>
		...
		<TD align="center">
			<asp:datagrid id="dgUserAccountList" runat="server" CssClass="grid" Width="550" AllowPaging="True"
				...
				<Columns>
					...
					<asp:BoundColumn DataField="UserGroupID" HeaderText="Group Name">
